...
/**
 * Description : ListViewTouchListener
 *
 * @author zimin
 * @date 2019/8/27
 */
public class ListViewTouchListener implements View.OnTouchListener {
	...
	/**
	 * The callback interface used by {@link ListViewTouchListener}
	 ...
	 * {@link ListViewTouchListener} is paused during list view
	 * scrolling.</p>
	 *
	 * @see ListViewTouchListener
	 */
